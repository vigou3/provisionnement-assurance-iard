...
Une compagnie d'assurance détient généralement une certaine expertise
sur le développement des sinistres par le biais de ses experts en
sinistres. Ceux-ci pourront effectuer des prévisions du montant total
d'un sinistre à différents moments entre la date de déclaration et la
date de fermeture d'un dossier, tel qu'illustré à la
...
\begin{exemple}
  ...
  l'évolution du développement de ce sinistre ainsi ainsi que les
  montants des provisions.

  \begin{figure}
    \centering
    \setlength{\unitlength}{3.35mm}
    \begin{picture}(38,16)(0,-6) \setlength{\fboxsep}{1.5pt}
      %% ligne du temps
      \thicklines
      \put(0.5,0.75){\vector(1,0){37.5}}
      \multiput(1,0.375)(1,0){37}{\line(0,1){0.75}}
      ...
      %% flèches vers les divers évènements
      \thinlines
      \put( 1.5,10){\vector(0,-1){8}}
      \put( 3.3,9){\vector(0,-1){7}}
      \put( 3.7,8){\vector(0,-1){6}}
      \put( 6.0,7){\vector(0,-1){5}}
      \put( 9.0,6){\vector(0,-1){4}}
      \put(20.0,6){\vector(0,-1){4}}
      \put(36.2,10){\vector(0,-1){8}}
      %% étiquettes des évènements
      \footnotesize
      \put( 1.65,9.5){{accident}}
      \put( 3.45,8.5){{poursuite}}
      \put( 3.85,7.5){{déclaration}}
      \put( 6.15,6.5){{rejet offre}}
      \put( 9.15,5.5){\parbox[t]{17mm}{avocats\par$\nombre{15 000}$~\$}}
      \put(20.15,5.5){\parbox[t]{17mm}{avocats\par$\nombre{30 000}$~\$}}
      \put(29.48,9.5){\parbox[t]{22mm}{\raggedleft règlement\par$\nombre{250 000}$~\$}}

      %% flèches vers les provisions
      \thinlines
      \color[rgb]{1,0.5,0}                % ~= "darkorange" de R
      \put(3.7,-6.5){\vector(0,1){5}}
      \put(5.0,-5.5){\vector(0,1){4}}
      %% étiquettes des provisions
      \footnotesize
      \put(3.85,-6.5){$\nombre{20 000}$~\$}
      \put(5.15,-5.5){$\nombre{200 000}$~\$}
    \end{picture}
    \caption{Évolution du développement du sinistre de l'\autoref{ex:presentation:pieton}}
